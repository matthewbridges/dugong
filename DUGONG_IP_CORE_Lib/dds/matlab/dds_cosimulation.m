...
x_cos_out_floating = x_cos_out(1:N2)/FULL_SCALE;

figure(1); plot(t, x_sin_out_floating, t, x_cos_out_floating);
xlabel('Time [seconds]'); ylabel('Amplitude [FS]');

PHASE_INCREMENT = 3*16^3;
...
xlabel('Frequency [Hz]'); ylabel('Ampitude [dBFS]');
